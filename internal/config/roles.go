...
func AllRoles() []string {
	return []string{"mayor", "deacon", "dog", "accountant", "librarian", "witness", "refinery", "architect", "engineer", "polecat", "crew"}
}
...
func RigRoles() []string {
	return []string{"witness", "refinery", "architect", "engineer", "polecat", "crew"}
}
