...
func ParseAddress(address string) (*AgentIdentity, error) {
	...
	case 2:
		...
		case string(RoleEngineer):
			return &AgentIdentity{Role: RoleEngineer, Rig: rig, Prefix: prefix}, nil
...
func ParseSessionNameWithRegistry(session string, registry *PrefixRegistry) (*AgentIdentity, error) {
	...
	// Check for engineer (suffix marker)
	if rest == string(RoleEngineer) {
		return &AgentIdentity{Role: RoleEngineer, Rig: rig, Prefix: prefix}, nil
	}
...
func (a *AgentIdentity) SessionName() string {
	...
	case RoleEngineer:
		return EngineerSessionName(a.prefix())
	case RoleCrew:
...
func (a *AgentIdentity) BeaconAddress() string {
	...
	case RoleEngineer:
		return BeaconRecipient("engineer", "", a.Rig)
	case RoleCrew:
...
func (a *AgentIdentity) Address() string {
	...
	case RoleEngineer:
		return fmt.Sprintf("%s/engineer", a.Rig)
	case RoleCrew:
